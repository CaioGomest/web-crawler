...
async function scrapeTerabyte() {
    ...
    // Carregar todos os produtos clicando no botão "Clique para ver mais produtos"
    while (loadMoreVisible) {
        try {
            console.log('Clicando no botão "Clique para ver mais produtos"...');
            await page.click(loadMoreButtonSelector);
            await page.waitForTimeout(5000); // Esperar um pouco mais para carregar os novos produtos
